...
plot(data["rooms"], data["price_usd"], "Загаьна площа", "Середня вартість", "Вартість квартир від загальної площі")
plt.show()

# Загальна площа і ціни на житло
plot(data.loc[data['rooms'] == 1]["area"], data.loc[data['rooms'] == 1]["price_usd"], "Загальна площа", "Середня вартість", "Вартість однокімнатних квартир від загальної площі")
plot(data.loc[data['rooms'] == 2]["area"], data.loc[data['rooms'] == 2]["price_usd"], "Загальна площа", "Середня вартість", "Вартість двокімнатних квартир від загальної площі")
plot(data.loc[data['rooms'] == 3]["area"], data.loc[data['rooms'] == 3]["price_usd"], "Загальна площа", "Середня вартість", "Вартість трикімнатних квартир від загальної площі")
plot(data.loc[data['rooms'] == 4]["area"], data.loc[data['rooms'] == 4]["price_usd"], "Загальна площа", "Середня вартість", "Вартість чотрьохкімнатних квартир від загальної площі")
plt.show()
